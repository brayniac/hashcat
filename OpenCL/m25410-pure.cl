...
KERNEL_FQ void m25410_init (KERN_ATTR_TMPS_ESALT (pdf14_tmp_t, pdf_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m25410_loop (KERN_ATTR_TMPS_ESALT (pdf14_tmp_t, pdf_t))
{
  /**
   * base
   */
  ...
  for (u32 i = 19; i>0; i--)
  {
    ...
    tmp[1] = (o_rc4_decryption_key[1] ^ xv) & 0xff;
  ...
  rc4_init_40 (S, o_rc4_decryption_key, lid);
...
KERNEL_FQ void m25410_comp (KERN_ATTR_TMPS_ESALT (pdf14_tmp_t, pdf_t))
{
  const u32 digest[4] =
  {
